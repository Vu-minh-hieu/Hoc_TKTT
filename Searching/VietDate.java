...
/******************************************************************************
 *  Compilation:  javac VietDate.java
 *  Execution:    java Date
 ...
 *  @author Kevin Wayne
 */
public class VietDate implements Comparable<VietDate> {
   ...
   /**
     ...
     */
    public VietDate(int day, int month, int year) {
        if (!isValid(month, day, year)) throw new IllegalArgumentException("Invalid VietDate");
        this.month = month;
        this.day   = day;
        this.year  = year;
    }
     ...
     */
    public VietDate next() {
        if (isValid(month, day + 1, year))    return new VietDate(day + 1, month, year);
        else if (isValid(month + 1, 1, year)) return new VietDate(1, month + 1, year);
        else                                  return new VietDate(1, 1, year + 1);
    }
     ...
     */
    public boolean isAfter(VietDate that) {
     ...
     */
    public boolean isBefore(VietDate that) {
        return compareTo(that) < 0;
    }
     ...
     */
    @Override
    public int compareTo(VietDate that) {
    ...
    public static void main(String[] args) {
        VietDate today = new VietDate(25, 2, 2004);
        ...
        VietDate birthday = new VietDate(16, 10, 1971);
        StdOut.println(birthday);
        for (int i = 0; i < 10; i++) {
            birthday = birthday.next();
            StdOut.println(birthday);
        }
        VietDate test = new VietDate("4/8/1955");
        StdOut.println(test);
    }
